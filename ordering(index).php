            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <!-- <h3>
                            <?php //echo "Mama Mungi Mangal Karyalay, Gangapur Road, Vidya Vikas Circle, Nashik, Maharashtra 422005"; ?>
                        </h3> -->
                        <!-- <h4>
                            <span>Email:</span> 
                            <?php// echo "Hindkesariii@gmail.com"; ?>
                            <br> 
                            <span>Phone:</span> 
                            <?php //echo "+91 7998370370"; ?>
                        </h4> -->
                    <!-- </div> -->
                <!-- </div> -->
                <!-- <div class="col-lg-6 sm-padding">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="widget_social">
                            <li><a href="https://www.facebook.com/profile.php?id=100089989688253&mibextid=LQQJ4d" data-toggle="tooltip" title="Facebook"><i class="fab fa-facebook-f fa-2x"></i></a></li>
                            <!-- <li><a href="#" data-toggle="tooltip" title="Twitter"><i class="fab fa-twitter fa-2x"></i></a></li> -->
                            <li><a href="https://www.instagram.com/hotelhindkesari?igsh=dXF2ajZ4bXppdWhh&utm_source=qr" data-toggle="tooltip" title="Instagram"><i class="fab fa-instagram fa-2x"></i></a></li>
                ...
                <div class="col-lg-3 col-md-6">
                     <div class="footer_widget">
                        <h3>Restaurant</h3>
                        <p>
                        Mama Mungi Mangal Karyalay, Gangapur Road, Vidya Vikas Circle, Nashik, Maharashtra 422005
                        </p>
                        <p>
                        Hindkesariii@gmail.com
                            <br>
                            +91 7998370370    
                        </p>
                     </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday-Sunday:12:00 AM - 11:00 PM</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
